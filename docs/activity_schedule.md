...
| `cronDirRequestCustomSequence.js` (custom menus) | `0 15 * * *<br>0 18 * * *` | Chain sosmed fetches, deliver Ditbinmas menu 21 to the Ditbinmas group, then send BIDHUMAS menus 6 and 9 to the BIDHUMAS group and its super admins. |
