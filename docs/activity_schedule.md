...
| `cronDirRequestCustomSequence.js` (custom menus) | `0 15 * * *<br>0 18 * * *<br>30 20 * * *` | Chain sosmed fetches, then deliver Ditbinmas menus 6, 9, 34, and 35 to super admins plus menu 30 to operators (with weekly/monthly contexts applied automatically). |
| `cronDirRequestCustomSequence.js` (Ditbinmas recap) | `30 20 * * *` | Send Ditbinmas menus 6, 9, 34, and 35 to super admins, plus menu 30 to Ditbinmas operators, adding weekly recaps on Sundays and monthly recaps on the last day of the month. |
