...
| `cronDirRequestCustomSequence.js` (custom menus) | `0 15 * * *<br>0 18 * * *` | Chain sosmed fetches, run Ditsamapta menu 6/9 (plus optional extras) to its group, super admins, and operators, deliver Ditbinmas menu 21 to the Ditbinmas group, then send BIDHUMAS menus 6, 9, and 28 to the BIDHUMAS group and its super admins. |
