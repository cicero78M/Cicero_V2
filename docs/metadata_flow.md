...
1. **Data Collection**
   - Cron jobs (`cronInstaLaphar.js`, `cronDirRequestFetchSosmed.js`, etc.) fetch posts, metrics, and rankings once the relevant WhatsApp client becomes ready. Results are saved to PostgreSQL and cached in Redis.
